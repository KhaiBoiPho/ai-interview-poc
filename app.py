...
def debug_inpainting(video_path, bbox_shift, extra_margin=10, parsing_mode="jaw", 
    ...
    info_text = "Parameter information:\n" + \
...
def download_model():
    ...
    required_models = {
        ...
        "MuseTalk": f"{CheckpointsDir}/musetalkV15/musetalk.json",  # noqa: F601
...
from musetalk.utils.utils import get_file_type, get_video_fps, datagen, load_all_model  # noqa: E402
from musetalk.utils.preprocessing import get_landmark_and_bbox, read_imgs, coord_placeholder, get_bbox_range  # noqa: E402
